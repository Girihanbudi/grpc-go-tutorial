...
func (UserRoles) Descriptor() protoreflect.EnumDescriptor {
	return file_protos_user_user_proto_enumTypes[0].Descriptor()
}

func (UserRoles) Type() protoreflect.EnumType {
	return &file_protos_user_user_proto_enumTypes[0]
}
...
func (UserGender) Descriptor() protoreflect.EnumDescriptor {
	return file_protos_user_user_proto_enumTypes[1].Descriptor()
}

func (UserGender) Type() protoreflect.EnumType {
	return &file_protos_user_user_proto_enumTypes[1]
}
...
type User struct {
	...
	Role     *UserRoles `protobuf:"varint,2,opt,name=role,proto3,enum=UserRoles,oneof" json:"role,omitempty"`
	Name     string     `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`
	Email    string     `protobuf:"bytes,4,opt,name=email,proto3" json:"email,omitempty"`
	Password string     `protobuf:"bytes,5,opt,name=password,proto3" json:"password,omitempty"`
	Gender   UserGender `protobuf:"varint,6,opt,name=gender,proto3,enum=UserGender" json:"gender,omitempty"`
}
...
func (x *GetUserDetail) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserDetail) ProtoMessage() {}

func (x *GetUserDetail) ProtoReflect() protoreflect.Message {
	mi := &file_protos_user_user_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetUserDetail.ProtoReflect.Descriptor instead.
func (*GetUserDetail) Descriptor() ([]byte, []int) {
	return file_protos_user_user_proto_rawDescGZIP(), []int{2}
}

func (x *GetUserDetail) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
var file_protos_user_user_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbb, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x13,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x02, 0x69, 0x64,
	0x88, 0x01, 0x01, 0x12, 0x23, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x0a, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x6f, 0x6c, 0x65, 0x73, 0x48, 0x01, 0x52,
	0x04, 0x72, 0x6f, 0x6c, 0x65, 0x88, 0x01, 0x01, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	...
	,
	...
	,
...
var file_protos_user_user_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_protos_user_user_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_protos_user_user_proto_goTypes = []interface{}{
	(UserRoles)(0),        // 0: UserRoles
	(UserGender)(0),       // 1: UserGender
	(*User)(nil),          // 2: User
	(*UserList)(nil),      // 3: UserList
	(*GetUserDetail)(nil), // 4: GetUserDetail
	(*emptypb.Empty)(nil), // 5: google.protobuf.Empty
}
var file_protos_user_user_proto_depIdxs = []int32{
	0, // 0: User.role:type_name -> UserRoles
	1, // 1: User.gender:type_name -> UserGender
	2, // 2: UserList.list:type_name -> User
	2, // 3: Users.Register:input_type -> User
	5, // 4: Users.List:input_type -> google.protobuf.Empty
	4, // 5: Users.UserDetail:input_type -> GetUserDetail
	5, // 6: Users.Register:output_type -> google.protobuf.Empty
	3, // 7: Users.List:output_type -> UserList
	2, // 8: Users.UserDetail:output_type -> User
...
func file_protos_user_user_proto_init() {
	...
	file_protos_user_user_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_protos_user_user_proto_enumTypes,
