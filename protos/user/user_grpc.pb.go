...
type UsersClient interface {
	...
	UserDetail(ctx context.Context, in *GetUserDetail, opts ...grpc.CallOption) (*User, error)
}
...
func (c *usersClient) UserDetail(ctx context.Context, in *GetUserDetail, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/Users/UserDetail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsersServer interface {
	...
	UserDetail(context.Context, *GetUserDetail) (*User, error)
...
func (UnimplementedUsersServer) UserDetail(context.Context, *GetUserDetail) (*User, error) {
...
func _Users_UserDetail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Users/UserDetail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServer).UserDetail(ctx, req.(*GetUserDetail))
	}
	return interceptor(ctx, in, info, handler)
}
